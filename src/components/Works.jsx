...
// Project Card with optimization
const ProjectCard = React.memo(({
  ...
  const CardContent = (
    <div className={`bg-tertiary p-5 rounded-2xl sm:w-[360px] w-full ${isMobile ? "shadow-none" : ""}`}>
  ...
  return (
    <motion.div variants={fadeIn("up", "spring", index * 0.3, 0.5)}>
      {isMobile ? CardContent : (
        <Tilt
          options={{ max: 25, scale: 1, speed: 300 }}
          className='w-full'
        >
          {CardContent}
        </Tilt>
    ...
    <>
      ...
      <div className='w-full flex'>
        ...
        >
          ...
          real-world examples. Each one includes a brief description, links to
          the code, and demonstrates my ability to build and manage full-stack
          applications.
        </motion.p>
      </div>
